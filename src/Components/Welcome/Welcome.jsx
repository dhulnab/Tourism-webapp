    ...
    <div>
      <div className={styles.content}>
        ...
        <p>
          ...
          انضم إلينا لتصبح جزءًا من مجتمع يربط بين المسافرين وشركات السياحة
          <br /> اختر رحلتك، احجز بسهولة، وشارك تجاربك، لنبني سويًا رحلات تمتلك
          طابعًا ثقافيًا استثنائيًا
        </p>
